...
- Середина февраля - 5й чекпойнт
    ...
    2. Проверка универсальности полученных результатов на дополнительных архитектурах, методах и датасетах.
...
- Конец марта-начало апреля - 6й чекпойнт:
    ...
    3. Проведение экспериментов c выбранными методами и идеями в области FL.
